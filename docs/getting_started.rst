...
6. Tab `Classify cells`:
    ...
    * `Add data to NN` offers the option to add new data to the NN and retrains the NN
     * to use this option, please download the training data from: `Link <https://drive.google.com/file/d/1irIMeew79byJGQG8ndEQEeWAb4ILQrB_/view?usp=sharing>`_
     
     https://drive.google.com/file/d/1irIMeew79byJGQG8ndEQEeWAb4ILQrB_/view?usp=sharing
